// tests/ct-checkout-003.spec.ts
import { test, expect } from '@playwright/test';

test('CT-Checkout-003 — Deixar "Last Name" em branco', async ({ page }) => {
  ...
  // --- Passo a Passo ---
  // 1) Preencher "First Name" e "Zip/Postal Code"
  ...
  // --- Resultado Esperado ---
  // Aparecer mensagem de erro "Error: Last Name is required"
